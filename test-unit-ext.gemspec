...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["lib/test_unit_ext.rb", "LICENSES", "README.mdown"]
  s.files = ["lib/test_unit_ext.rb", "LICENSES", "Rakefile", "README.mdown", "Manifest", "test-unit-ext.gemspec"]
  s.has_rdoc = true
